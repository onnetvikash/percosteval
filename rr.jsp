...
try{				
	...
	PreparedStatement ps2 = con2.prepareStatement("insert into downs (uid,uname,fid,fname,mdata,filesize,filepath,start12,start24)VALUES(?,?,?,?,?,?,?,?,?)");
	ps2.setInt(1,uid);
