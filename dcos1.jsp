...
.CSSTableGenerator td{
	vertical-align:middle;
		background:-o-linear-gradient(bottom, #af63b7 5%, #ffffaa 100%);	background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #af63b7), color-stop(1, #ffffaa) ); 
	background:-moz-linear-gradient( center top, #af63b7 5%, #ffffaa 100% );
	filter:progid:DXImageTransform.Microsoft.gradient(startColorstr="#af63b7", endColorstr="#ffffaa");	background: -o-linear-gradient(top,#af63b7,ffffaa);
...
.CSSTableGenerator tr:first-child td{
		background:-o-linear-gradient(bottom, #191902 5%, #00ff7f 100%);	background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #191902), color-stop(1, #00ff7f) );
	background:-moz-linear-gradient( center top, #191902 5%, #00ff7f 100% );
	filter:progid:DXImageTransform.Microsoft.gradient(startColorstr="#191902", endColorstr="#00ff7f");	background: -o-linear-gradient(top,#191902,00ff7f);
	...
	<div id="templatemo_wrapper">
      ...
      <p>&nbsp; </p>
        ...
        <div id="templatemo_content_wrapper">
			...
			<tr    >
			<td width="74"  ><font  color="#3300FF" size="2"><strong>File Name</strong></font></td>
			
            <td width="114"><font color="#3300FF"  size="2"><strong>Start_time for file upload</strong></font></td>

<td width="109"><font  color="#3300FF" size="2"><strong>End_time for file upload</strong></font></td>
	<td width="81"><font  color="#3300FF" size="2"><strong>File Size</strong></font></td>
		
		<td width="93"><font  color="#3300FF" size="2"><strong>Usage Time</strong></font></td>
		
		
			<td width="116"><font   color="#3300FF" size="2"><strong>Total Price</strong></font></td>
...
con=databasecon.getconnection();
 ...
 String sqll="select * from downs1 where uname='"+name2+"' ";
