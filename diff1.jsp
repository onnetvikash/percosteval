...
String myserver=null;
  				double ans1=0.0d,ans2=0.0d,ans3=0.0d;
							...
							try{
								...
								String str1="select * from downs where uname='"+name+"' ";
...
<%
            ...
            try {
                ...
                final File file1 = new File("E:/apache-tomcat-6.0.18/apache-tomcat-6.0.18/webapps/adaptive encryption/images/barchart.png");
				//D:\apache-tomcat-6.0.18\apache-tomcat-6.0.18\webapps\adaptive encryption\images
