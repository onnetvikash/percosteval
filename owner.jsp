      ...
      <p>&nbsp; </p>
        ...
        <div id="templatemo_menu">
            <ul>
                ...
                <li><a href="v.jsp">masterkey1 request</a></li>
              <li><a href="h.jsp">masterkey2 request</a></li>
			  <li><a href="ll.jsp">Uploaded File Details</a></li>
			   <li><a href="cc1.jsp">chart</a></li>
        ...
        <div class="CSSTableGenerator">
          ...
          <table align="center" width="663" height="221" ><tr>
			  <td  colspan="2"align="center"><font size="3"  color="#FFCC00">
			  <b>Welcome:</b></font>&nbsp;<font size="3" color="#000000"><b><%=aa%></b></font></td></tr>
			  <tr><td width="255" height="162"><marquee  behavior="alternate">
			<img src="images/slider/upload1.png"></marquee></td> 
			  <td width="312">
			  <form action="test.jsp">
			  <table width="299" height="102" >
			  <tr><td>Data_Name</td>
			  <td><input type="text" name="dname"></td>
			  </tr>
			  <tr><td>Meta Data</td>
			  <td><input type="text" name="mdata"></td>
			  </tr>
			  <tr><td></td>
