...
.CSSTableGenerator td{
	vertical-align:middle;
		background:-o-linear-gradient(bottom, #e0d0e0 5%, #edd7d7 100%);	background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #e0d0e0), color-stop(1, #edd7d7) ); 
	background:-moz-linear-gradient( center top, #e0d0e0 5%, #edd7d7 100% );
	filter:progid:DXImageTransform.Microsoft.gradient(startColorstr="#e0d0e0", endColorstr="#edd7d7");	background: -o-linear-gradient(top,#e0d0e0,edd7d7);
...
.CSSTableGenerator tr:first-child td{
		background:-o-linear-gradient(bottom, #3f007f 5%, #35f2f2 100%);	background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #3f007f), color-stop(1, #35f2f2) );
	background:-moz-linear-gradient( center top, #3f007f 5%, #35f2f2 100% );
	filter:progid:DXImageTransform.Microsoft.gradient(startColorstr="#3f007f", endColorstr="#35f2f2");	background: -o-linear-gradient(top,#3f007f,35f2f2);
	...
	<div id="templatemo_wrapper">
      ...
      <p>&nbsp; </p>
        ...
        <div class="CSSTableGenerator">
		  ...
		  <table align="center"><tr><td colspan="2">Success page</td></tr>
		  
		  <tr><td><img src="images/slider/success1.png"></td>
		  <td><a href="index.html"><font size="+3"><b>Logout</b></font></a></td></tr>
		  </table>
