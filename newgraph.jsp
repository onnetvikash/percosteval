...
JFreeChart chart = ChartFactory .createBarChart3D("Patient", "accno", "hypertension",dataset, PlotOrientation.VERTICAL, true, true, false);
                
try
{
ChartUtilities.saveChartAsJPEG(new File("E:/apache-tomcat-6.0.18/webapps/adaptive encryption/images/new.jpg"), chart, 700, 300);
	...
	<div id="templatemo_wrapper">
      ...
      <p>&nbsp; </p>
        ...
        <div class="CSSTableGenerator">
		 ...
		 <table><tr><td><img  src="images/new.jpg"></td></tr></table>
