      ...
      <p>&nbsp; </p>
        ...
        <div id="templatemo_content_wrapper">
			<div id="content">
              ...
              <table width="488" height="303" align="center"><tr>
			  <td  colspan="2"align="center"><font size="3"  color="#FFCC00">
			  <b>User Register Here</b></font></td></tr>
			  <tr><td><marquee  behavior="alternate">
			<img src="images/slider/signup1.png"></marquee></td> 
			  <td><form action="register1.jsp" name="f1" onsubmit="return validation1();">
