...
<%
		...
		try{	
			...
			PreparedStatement ps=conn.prepareStatement("select * from downs1 where fid = '"+ff+"'");
...
query="update downs1 set end12='"+end12+"',end24='"+end24+"',sizeprize='"+sprz+"',usageprize='"+upz+"',totalprize='"+tpz+"',usagetime='"+fge+"',nof='"+nof+"',tfs='"+finalsizer1+"' where fid='"+ff+"';";
	try{				
