...
var a=document.f.key.value;

if(a=="")
{

alert("First enter the security key value");
      ...
      <p>&nbsp; </p>
        ...
        <div id="templatemo_menu">
            <ul>
                ...
                <li><a href="cp.jsp">Security code_request</a></li>
                <li><a href="dcos.jsp">download file performence</a></li>
				 <li><a href="dcos1.jsp">Decrypted download file performence</a></li>
                <li><a href="diff1.jsp">Differrence</a></li>
            </ul>    	
...
<div class="CSSTableGenerator"><form action="check.jsp" name="f" onsubmit="return validation();">
               <table width="364" height="176" align="center"><tr><td colspan="2">User Page:<%=a%></td></tr>
			   
			   
			   <tr><td><font size="3"><b>Enter Your security code</b></font> </td>
